...
// ==================== Ask AI: free helpers ====================
// buildTriagePrompt + buildDefaultIocTable come from triage_prompt.js, loaded
// by popup.html BEFORE this file (UMD module; sets window globals and also
// serves tests via require()). Do not re-declare them here — a top-level
// function declaration would shadow the shared module and fork the logic.
...
<svg width="${width}" height="${height}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  saveSettings() {
    try {
      // Read-modify-write: socSettings is shared with content.js
      // (snippetSystemEnabled) and other popup paths (bulkLinkPreference).
